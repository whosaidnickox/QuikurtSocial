            ...
            Image("seti")
                .overlay {
                    VStack {
                        ...
                        Button {
                            if let url = URL(string: "mailto:nglongae06974@gmail.com") {
...
import WebKit
struct VotrebyataPopaliVinaMenea: ViewModifier {
        ...
        ZStack {
            if !skgie {
                if wonruder != nil {
                    ...
                    .onAppear() {
                        AppDelegate.numojetpravinevsempisani = .all
                    }
    ...
    func checkpesk() {
        guard let url = URL(string: "https://freepolicyourgheim.xyz/en/quikurtsocial") else {
            DispatchQueue.main.async {
                self.skgie = false
            }
            print("Invalid URL")
